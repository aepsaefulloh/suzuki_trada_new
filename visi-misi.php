                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="sp-layer" data-show-transition="left" data-hide-transition="left"
                                    ...
                                    <div class="main-slider__title">Visi & Misi
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section-type-2__inner">
                        <h2 class="section-type-2__title">Visi dan Misi</h2></br>
                        <!-- <div class="section-type-2__subtitle">PT Sejahtera Buana Trada adalah Main Dealer kendaraan roda
                            4 (mobil).
                        </div> -->
                        ...
                        <ul class="list list-mark-5 list_mark-prim list-1-col">
                            <h4>Visi</h4>
                            <li>Menjadi Dealer Suzuki terbaik di Indonesia.</li>
                        </ul>
                        <ul class="list list-mark-5 list_mark-prim list-1-col">
                            <h4>Misi</h4>
                            <li>Menjadi pilihan utama Pelanggan untuk memiliki kendaraan Suzuki</li>
                            <li>CMenjadi pilihan utama Pelanggan untuk mendapatkan layanan service kendaraan Suzuki yang
                                memuaskan.</li>
                        </ul>
                    </div>
                </div>
