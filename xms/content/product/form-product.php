            ...
            <div class="widgetbox box-inverse">
                ...
                <div class="widgetcontent nopadding">
					...
					<input type='hidden' name='ACT' value='<?php echo $act?>'>
                            <p>
                                <label>Product</label>
                                <span class="field"><input type="text" name="PRODUCT" id="firstname2" class="input-block-level" value="<?php echo $objDetail['PRODUCT']?>"></span>
                            </p>
                            ...
                            <p>
                                <label>Content</label>
                                <span class="field"><textarea cols="80" rows="5" name="SPECS" id="location2" class="span5 mceEditor"><?php echo $objDetail['SPECS']?></textarea></span>
                            </p>
							
							<p>
                                <label>Price</label>
                                <span class="field"><input type="text" name="PRICE" id="lastname2" class="input-block-level" value='<?php echo $objDetail['PRICE']?>'></span>
                            </p>
							...
							<p>
                                ...
                                <span class="field"><input type="file" name="BROCHURE" id="lastname2" class="input-xxlarge"><br><br>
								<img src="<?php echo ROOT_URL.'/images/product/'.$objDetail['BROCHURE']?>" width='300px'>
								</span>
