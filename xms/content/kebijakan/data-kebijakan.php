...
//GET KATEGORI
$objKbj=array();
$listCt=getCache('category');
foreach($listCt as $list){
	if ($list['TIPE']=='kebijakan'){
		$objKbj[$list['ID']]=$list['CATEGORY'];	
	}
}
				...
				<table class="table table-bordered responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href='<?php echo $url?>' target='_blank'><?php echo substr($list['TITLE'],0,50)?>...</a></td>
							<td><?php echo $objKbj[$list['SUBCATEGORY']]?></td>
                            <td>
