...
$list=getRecord('tbl_photo',$params);
				...
				<table class="table table-bordered responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo $list['PERMALINK']?>" target='_blank'><?php echo $list['JUDUL']?></a></td>
                            <td><div class="thumb"><img src="<?php echo $list['THUMBNAIL']?>" style="max-width:70px"></div></td>
