                ...
                <div class="widgetcontent nopadding">
					...
					<input type='hidden' name='ACT' value='<?php echo $act?>'>
							...
							<p>
								...
								<option value="LEADERBOARD" <?php if($objDetail['POS']=='LEADERBOARD') echo 'selected'?>>LEADERBOARD</option>
								</select>
								</span>
                            </p>
							...
							<p>
								...
								<img src="<?php echo CMS_URL.'/files/banners/'.$objDetail['FILENAME']?>" width='300px'>
								</span>
