...
if($submitcontent=='1'){	
	...
	if($_FILES['IMAGE']['name'] != "") {		
		...
		if (in_array($ext, $allowExt)){
			...
			$target=CMS_PATH.'/files/'.date('Ym').'/'.$nfname;
			checkFolder();
			move_uploaded_file($_FILES['IMAGE']['tmp_name'],$target);
			$objVar['IMAGE_FOLDER']=date('Ym');
			$objVar['IMAGE']=$nfname;
		}
	}
				...
				<table class="table table-bordered responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src='<?php echo CMS_URL.'/files/banners/'.$list['FILENAME']?>' style='max-width:300px'></td>
                            <td>
