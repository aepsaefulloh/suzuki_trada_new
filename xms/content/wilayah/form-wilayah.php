...
if($params['ID']>0){
	$act='EDIT';	
	$objDetail=getRecord('tbl_propinsi',$params);
                ...
                <div class="widgetcontent nopadding">
					...
					<input type='hidden' name='ACT' value='<?php echo $act?>'>
                            <p>
                                ...
                                <span class="field"><input type="text" name="PROPINSI" id="firstname2" class="input-block-level" value="<?php echo $objDetail['PROPINSI']?>"></span>
                            </p>
							<p>
                                <label>IBUKOTA</label>
                                <span class="field"><input type="text" name="IBUKOTA" id="firstname2" class="input-block-level" value="<?php echo $objDetail['IBUKOTA']?>"></span>
                            </p>
							...
							<p>
                                <label>KODEISO</label>
                                <span class="field"><input type="text" name="KODEISO" id="firstname2" class="input-block-level" value="<?php echo $objDetail['KODEISO']?>"></span>
                            </p>
							
							<p>
                                <label>LUAS</label>
                                <span class="field"><input type="text" name="LUAS" id="firstname2" class="input-block-level" value="<?php echo $objDetail['LUAS']?>"></span>
                            </p>
							
							<p>
                                <label>POPULASI</label>
                                <span class="field"><input type="text" name="POPULASI" id="firstname2" class="input-block-level" value="<?php echo $objDetail['POPULASI']?>"></span>
                            </p>
