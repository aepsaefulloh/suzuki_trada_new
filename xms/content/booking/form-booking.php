                ...
                <div class="widgetcontent nopadding">
					...
					<input type='hidden' name='ACT' value='<?php echo $act?>'>
							...
							<p>
                                ...
                                <span class="field"><input type="text" name="CARYEAR" id="firstname2" class="input-block-level" value="<?php echo $objDetail['CARYEAR']?>"></span>
                            </p>
							
                            <p>
                                <label>Tanggal Booking</label>
                                <span class="field"><input type="date" name="BTIMESTAMP" id="firstname2" class="input-block-level" value="<?php echo $objDetail['BTIMESTAMP']?>"></span>
                            </p>
