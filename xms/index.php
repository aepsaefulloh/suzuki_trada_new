...
<link rel="stylesheet" href="css/responsive-tables.css?v=<?php echo rand()?>">
<link rel="stylesheet" href="css/uniform.tp.css?v=<?php echo rand()?>">
...
<script src="<?php echo CMS_URL?>/tinymce/js/tinymce/tinymce.min.js"></script>
<script type="text/javascript">
tinymce.init({
	mode : "specific_textareas",
     editor_selector : /(mceEditor|mceRichText)/,height: 500,
	relative_urls : false,
    theme: "modern",
    subfolder:"",
    plugins: [
