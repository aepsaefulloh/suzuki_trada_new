    ...
    <div class="section-title-page area-bg area-bg_dark area-bg_op_70">
        <div class="area-bg__inner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h1 class="b-title-page bg-primary_a">Berita Perusahaan</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Berita Perusahaan</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <main class="l-main-content">
                    ...
                    <?php 
                      ...
                      // echo $totalpage
                      $prev = ROOT_URL.'/berita-perusahaan.php?page='.($page-1);
                      $next = ROOT_URL.'/berita-perusahaan.php?page='.($page+1);
                      ?>
                    <ul class="pagination">
                        <?php 
                            if ($page > 1){
                        ...
                        <?php 
                            ...
                            $urlpage = ROOT_URL.'/berita-perusahaan.php?page='.$i;
                        ?>
